			...
			<div class="wrap-login100">
                <form method="POST" class="login100-form validate-form" action="{{ route('register') }}">
                    ...
                    <div class="wrap-input100 validate-input" >
						<input class="input100" type="text" name="name" @error('email') is-invalid @enderror" name="name" value="{{ old('name') }}" required autocomplete="name" autofocus>
					...
					<div class="wrap-input100 validate-input" data-validate = "Valid email is: a@b.c">
						<input class="input100" type="text" name="email" @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus>
                    ...
                    <div class="wrap-input100 validate-input" data-validate="Confirm Password">
                        ...
                        <input id="password-confirm" type="password" name="password_confirmation" class="input100"  name="password_confirmation" required autocomplete="new-password">
                    ...
                    <div class="wrap-input100 validate-input" data-validate="Enter city">
						...
						<input class="input100" type="text"  @error('city') is-invalid @enderror" name="city">
					...
					<div class="wrap-input100 validate-input" data-validate="Enter date">
						...
						<input class="input100" type="text"  @error('date') is-invalid @enderror" name="date">
